      ...
      <div className="grid grid-cols-1 lg:grid-cols-2">
        ...
        <div className="flex items-center justify-center px-4 py-10 sm:px-6 sm:py-16 lg:px-8 lg:py-24">
          <div className="xl:mx-auto xl:w-full xl:max-w-sm 2xl:max-w-md">
            <h2 className="text-3xl font-bold leading-tight text-left text-black sm:text-4xl">Sign in</h2>
            <p className="mt-2 text-sm text-left text-gray-600">
              Don&apos;t have an account?{' '}
              <a
                href="#"
                title=""
                className="text-left font-semibold text-black transition-all duration-200 hover:underline"
              >
              ...
              <div className="space-y-5">
                ...
                <div>
                  <div className="flex items-center justify-between">
                    <label htmlFor="" className="text-base text-left font-medium text-gray-900">
                      {' '}
                      Password{' '}
                    </label>
                    <a
